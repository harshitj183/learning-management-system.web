                    ...
                    <div className="flex flex-col gap-[50px] w-full">
                        ...
                        <div className="flex flex-col gap-[24px] w-full">
                            ...
                            <div className="flex flex-col gap-[20px] w-full">
                                ...
                                {/* Confirm Password */}
                                <div className="flex flex-col gap-[8px]">
                                    <label htmlFor="confirm-password" className="text-[16px] font-medium text-[#9794AA]">Confirm Password</label>
                                    <div className="h-[56px] border border-[#9794AA] rounded-[6px] px-[20px] flex items-center">
                                        <input
                                            id="confirm-password"
                                            type="password"
                            ...
                            <label className="flex items-start gap-2 cursor-pointer">
                                <input type="checkbox" className="w-4 h-4 mt-1 accent-[#FDC832]" required />
                                <span className="text-[14px] text-[#696F79]">
                                    I agree to the{" "}
                                    <Link href="/terms" className="text-[#FDC832] hover:underline">
                                        Terms & Conditions
                                    </Link>
                                </span>
                            </label>
                        ...
                        <div className="text-center">
                            <p className="text-[16px] text-[#8692A6]">
                                ...
                                <Link href="/teacher/login" className="text-[#FDC832] font-semibold hover:underline">
                                    Login
                                </Link>
                            </p>
                        </div>
